    ...
    async execute(interaction) {
        ...
        */
        ...
        if (!grupo && sub === "desativar") {
            ...
            return interaction.reply({ content: "✅ AutoMod **desativado**.", ephemeral: true });
        ...
        */
        ...
        if (grupo === "palavras") {
            ...
            if (sub === "adicionar") {
                ...
                return interaction.reply({ content: `✅ Palavra adicionada à lista de bloqueio.`, ephemeral: true });
            ...
            if (sub === "remover") {
                ...
                return interaction.reply({ content: `✅ Palavra removida da lista de bloqueio.`, ephemeral: true });
        ...
        if (grupo === "raid") {
            ...
            if (sub === "configurar") {
                ...
                if (!Object.keys(campos).length) {
                    ...
                    return interaction.reply({ content: "⚠️ Informe pelo menos uma opção pra alterar.", ephemeral: true });
        ...
        if (grupo === "ignorar") {
            ...
            if (sub === "canal") {
                ...
                if (jaIgnorado) {
                    ...
                    return interaction.reply({ content: `✅ ${canal} removido das exceções — o AutoMod volta a agir nele.`, ephemeral: true });

                }

                await AutomodRepository.adicionarNaLista(guild.id, "ignored_channels", canal.id);

                return interaction.reply({ content: `✅ ${canal} adicionado às exceções — o AutoMod nunca vai mexer lá.`, ephemeral: true });
            ...
            if (sub === "cargo") {
                ...
                if (jaIgnorado) {
                    ...
                    return interaction.reply({ content: `✅ ${cargo} removido das exceções.`, ephemeral: true });

                }

                await AutomodRepository.adicionarNaLista(guild.id, "ignored_roles", cargo.id);

                return interaction.reply({ content: `✅ Quem tem o cargo ${cargo} agora é ignorado pelo AutoMod.`, ephemeral: true });
